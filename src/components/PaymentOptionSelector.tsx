...
export default function PaymentOptionSelector({
  ...
  const cards: CardConfig[] = [
    {
      key: "garage_dossier",
      title: "Vous payez les frais de dossier",
      subtitle: "Votre client paiera uniquement les frais de carte grise",
      garagePays: fraisDossier,
      garageLabel: `${fmt(fraisDossier)} EUR (débit jetons)`,
    ...
    {
      key: "garage_tout",
      title: "Vous payez tout",
      subtitle: "Votre client n'a rien à payer",
      garagePays: total,
      garageLabel: `${fmt(total)} EUR (débit jetons)`,
      clientPays: 0,
      clientLabel: "0 EUR",
