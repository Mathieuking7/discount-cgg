...
const PRO_TYPES_WITH_PLATE = ["DUPLICATA_CG_PRO", "FIV_PRO", "MODIF_CG_PRO", "ANNULATION_CPI_WW_PRO", "SUCCESSION_HERITAGE_PRO", "COTITULAIRE_PRO", "ANNULER_CORRIGER_DC_DA_PRO"];
